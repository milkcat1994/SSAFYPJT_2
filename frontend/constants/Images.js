...
const UnknownProfileImg = require('../assets/imgs/unknown-profile-img.png');
...
const First = require('../assets/imgs/first.png');
const Second = require('../assets/imgs/second.png');
const Third = require('../assets/imgs/third.png');
const NonImage = require('../assets/imgs/nonImage.png');
